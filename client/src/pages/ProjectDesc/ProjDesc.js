...
function ProjDesc() {
    ...
    const [projUpdate,setProjUpdate] = useState([]);
    ...
    const getUpdate=async()=>{
        ...
        const response= await fetch('http://localhost:8050/updateProj/getUpdate',{
          method:"POST",
          body:JSON.stringify({
            id:id
          }),
        ...
        <div className='projDescPage'>
            ...
            <div className='addSeeComments'>
                <div className='updates'>
                    ...
                    {
                        projUpdate.map(proj=>(
                            <UpdateComment data={proj.update}/>
                        ))
                    }
                </div>
